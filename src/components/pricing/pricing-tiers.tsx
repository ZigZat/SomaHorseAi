    ...
    >
      {tier.popular && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-navy-mid px-4 py-1.5 text-xs font-semibold text-white shadow-glow">
      ...
      <Link
        href="#start"
        className={`mt-8 flex min-h-12 items-center justify-center gap-2 rounded-full px-6 text-sm font-semibold transition ${
          tier.popular
