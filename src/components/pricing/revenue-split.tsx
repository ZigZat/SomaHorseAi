        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          >
            <div className="mb-8 flex items-center gap-3">
              ...
              <div>
                <h3 className="font-display text-xl font-bold text-navy">Revenue Distribution</h3>
            ...
            <div className="space-y-6">
              ...
              <div>
                <div className="mb-2 flex items-center justify-between">
                  <span className="font-semibold text-navy">Somahorse.ai</span>
          ...
          <div className="space-y-6">
            ...
            >
              <div className="mb-4 flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-display text-xl font-bold text-navy">Certified Network</h3>
            ...
            >
              <div className="mb-4 flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-display text-xl font-bold text-navy">Market Opportunity</h3>
