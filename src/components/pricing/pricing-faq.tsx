  ...
  return (
    <section className="px-2 py-24 sm:px-3">
      <div className="mx-auto max-w-4xl">
        ...
        >
          <h3 className="font-display text-xl font-bold text-navy">Still have questions?</h3>
          <p className="mt-2 text-sm text-muted-foreground">
            Our team is here to help you find the right solution for your agricultural project.
          </p>
          <button className="mt-6 inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-navy-mid px-7 text-sm font-semibold text-white shadow-glow transition hover:bg-navy">
            Contact support
          </button>
        </motion.div>
      </div>
