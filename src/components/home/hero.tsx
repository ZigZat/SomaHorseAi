  ...
  return (
    <section className="relative isolate overflow-hidden px-2 pb-20 pt-3 sm:px-3">
      ...
      <div className="relative z-10 mx-auto flex min-h-[88svh] max-w-4xl flex-col items-center justify-center px-4 pt-28 pb-16 text-center sm:pt-32">
        <Link
          href="#platform"
          className="mb-7 flex items-center gap-2 rounded-full border border-navy-mid/15 bg-white/70 px-4 py-1.5 text-xs font-semibold text-navy-mid backdrop-blur animate-fade-up hover:bg-blue-light"
        >
        ...
        >
          ...
          <Link
            href="#how-it-works"
            className="flex min-h-12 items-center justify-center gap-2 rounded-full border border-border-strong bg-white/80 px-7 text-sm font-semibold text-navy transition hover:border-navy-mid/25 hover:bg-blue-mist"
          >
