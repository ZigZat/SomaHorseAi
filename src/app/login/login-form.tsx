          ...
          <div className="rounded-3xl border border-border/80 bg-white/80 p-8 shadow-elevated backdrop-blur-xl sm:p-10">
            ...
            {isSuccess ? (
              <div className="py-8 text-center animate-fade-up">
                ...
                <h3 className="font-display text-lg font-bold text-navy">Authentication Successful</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-1.5">
                  <label htmlFor="email" className="text-xs font-bold text-navy-mid/80 tracking-wide uppercase font-display">
                    Email Address
                  </label>
                ...
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    <label htmlFor="password" className="text-xs font-bold text-navy-mid/80 tracking-wide uppercase font-display">
                      Password
                    </label>
                    <Link
                      href="#"
                      className="text-xs font-semibold text-blue-vivid hover:text-navy transition-colors"
                    >
                      Forgot password?
                    </Link>
                  </div>
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full min-h-11 flex items-center justify-center gap-2 rounded-full bg-navy-mid text-sm font-semibold text-white shadow-glow transition hover:bg-navy disabled:opacity-75 disabled:cursor-not-allowed cursor-pointer"
                >
                  {isLoading ? (
                    <>
                ...
                <div className="relative my-6 flex items-center justify-center">
                  ...
                  <span className="relative bg-white/0 px-3 text-xs font-semibold text-muted-foreground/60 uppercase font-display">
                    Or continue with
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    type="button"
                    className="flex min-h-10.5 items-center justify-center gap-2 rounded-full border border-border-strong bg-white/70 text-xs font-bold text-navy shadow-soft hover:bg-white transition-all cursor-pointer"
                  >
